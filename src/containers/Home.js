    ...
    <div className="home-container">
      ...
      <div className="container m-5 model">
        ...
        <Carousel breakPoints={breakPoints} enableAutoPlay autoPlaySpeed={1500}>
          ...
          <div className="slides">
            <div className="card">
              <img src="https://hips.hearstapps.com/hmg-prod/amv-prod-cad-assets/images/media/51/2012-cadillac-cts-inline-678-photo-623583-s-original.jpg" className="card-img-top" alt="cadillac" />
            </div>
          </div>
          <div className="slides">
            <div className="card">
              <img src="https://stimg.cardekho.com/images/carexteriorimages/630x420/Cadillac/Cadillac-CTS/2785/1560319395535/front-left-side-47.jpg" className="card-img-top" alt="cadillac" />
            </div>
          </div>
          <div className="slides">
            <div className="card">
