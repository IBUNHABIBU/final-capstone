    ...
    <div>
      <div className="d-flex align-items-start">
        ...
        <div className="tab-content" id="v-pills-tabContent">
          ...
          <div className={ tab === 3 ? "tab-pane fade show active" : "tab-pane fade"} id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">ldiedkaa ia 'd'laie adlaie aidioae</div>
